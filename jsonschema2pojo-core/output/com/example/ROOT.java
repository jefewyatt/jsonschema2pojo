...
public class ROOT {
    ...
    private List<PatternProperties> patternProperties;
    @JsonIgnore
     ...
     */
    @JsonProperty("patternProperties")
    public List<PatternProperties> getPatternProperties() {
     ...
     */
    @JsonProperty("patternProperties")
    public void setPatternProperties(List<PatternProperties> patternProperties) {
